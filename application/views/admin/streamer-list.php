                            ...
                            <?php foreach ($users as $streamer) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if ($streamer->isStreamer == 1) { ?>
                                            <a href="<?= base_url('admin/product/changeStreamer/3/') . $streamer->id ?>" class="text-danger">De-Aktifleştir</a>
                                        <?php } else { ?>
                                            <a href="<?= base_url('admin/product/changeStreamer/1/') . $streamer->id ?>" class="text-success">Aktifleştir</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
