    ...
    <main>
        <div class="container-fluid">
            <div class="page-title">
                <h5 class="mb-0">Abonelik Düzenle</h5>
            </div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Abonelik Düzenle</li>
                </ol>
            </nav>

            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url(); ?>admin/subscription/update_subscription" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="inputPDescription" class="col-sm-2 col-form-label">Abonelik Açıklaması:</label>
                            <div class="col-sm-10">
                                <textarea id="editor" rows="10" class="form-control" name="description"><?= $subscription->description ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" step="0.01" min="1" class="form-control" id="inputPPrice" name="price" value="<?= $subscription->price ?>" placeholder="Örneğin: 19.99" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" step="1" class="form-control" id="inputPDuration" name="duration" value="<?= $subscription->duration ?>" placeholder="Örneğin: 30" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" id="discount_commission" name="discount_commission" required>
                                    <option value="0" <?= $subscription->commission_value == null ? 'selected' : '' ?>>Komisyon İndirimi Uygulama</option>
                                    <option value="1" <?= $subscription->commission_value != null ? 'selected' : '' ?>>Komisyon İndirimi Uygula</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group row alert alert-primary" id="discount_commission_input" style="display: <?= $subscription->commission_value != null ? 'flex' : 'none' ?>;">
                            <label for="discount_commission_value" class="col-sm-2 col-form-label">Komisyon Miktarı (%):</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="discount_commission_value" min="0" max="100" placeholder="Örneğin: 1,99" name="discount_commission_value" step="any" value="<?= $subscription->commission_value ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" id="refund_balance" name="refund_balance" required>
                                    <option value="0" <?= $subscription->refund_value == null ? 'selected' : '' ?>>Bakiye İadesi Uygulama</option>
                                    <option value="1" <?= $subscription->refund_value != null ? 'selected' : '' ?>>Bakiye İadesi Uygula</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group row alert alert-primary" id="refund_balance_input" style="display: <?= $subscription->refund_value != null ? 'flex' : 'none' ?>;">
                            <label for="refund_balance_value" class="col-sm-2 col-form-label">İade Tutarı (Yüzde Olarak):</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="refund_balance_value" min="0" max="100" placeholder="Örneğin: 0.5" name="refund_balance_value" step="0.1" value="<?= $subscription->refund_value ?>">
                            </div>
                        </div>

                        <div class="form-group row alert alert-primary" id="refund_max_balance_input" style="display: <?= $subscription->max_refund_value != null ? 'flex' : 'none' ?>;">
                            <label for="refund_max_balance_value" class="col-sm-2 col-form-label">Maksimum İade Tutarı (TL):</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="refund_max_balance_value" min="0" placeholder="Örneğin: 15" name="refund_max_balance_value" step="0.1" value="<?= $subscription->max_refund_value ?>">
                        ...
                        <button class="btn btn-primary float-right" id="submit_button"><i class="fa fa-save"></i> Güncelle</button>
                    </form>
                </div>
            </div>
        </div>
