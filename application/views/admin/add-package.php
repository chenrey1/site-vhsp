...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url(); ?>admin/product/insertPackage" method="POST" id="packageForm">
                        <div class="form-group row">
                            <label for="packageName" class="col-sm-2 col-form-label">Paket Adı:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="packageName" onchange="doSlug()" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="packageSlug" class="col-sm-2 col-form-label">Slug:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="slug" id="packageSlug" placeholder="Otomatik oluşturulacak, boş bırakabilirsiniz">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="packageDescription" rows="4" placeholder="Paket hakkında açıklama (opsiyonel)"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" name="price" id="packagePrice" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" name="discount_percent" id="packageDiscount" value="0" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="sort_order" id="packageSort" value="0">
