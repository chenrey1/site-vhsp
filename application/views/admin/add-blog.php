...
<main>
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h5 class="mb-0">Yazı Oluştur</h5>
        </div>

        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('admin/blog'); ?>">Blog</a></li>
                <li class="breadcrumb-item active" aria-current="page">Yazı Oluştur</li>
            </ol>
        </nav>

        <div class="card">
            <div class="card-body">
                <form action="<?= base_url('admin/product/insert/blog/blog/blog') ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="inputPName" class="col-sm-2 col-form-label">Başlık:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" id="title" onchange="doSlug()" required>
                        </div>
                    </div>
                    <div class="form-group row">
